        ...
        <form
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, firstName: undefined }));
            }}
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, lastName: undefined }));
            }}
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              if (/^\d{4}-\d{2}-\d{2}$/.test(enteredDate)) {
                ...
                setError((prevError) => ({ ...prevError, dateOfBirth: undefined }));
              } else {
                // Display an error for invalid date format
                setError((prevError) => ({ ...prevError, dateOfBirth: ["Invalid date format"] }));
              }
            }}
          />
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, phoneNumber: undefined }));
            }}
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, country: undefined }));
            }}
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, city: undefined }));
            }}
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setError((prevError) => ({ ...prevError, photo: undefined }));
            }}
